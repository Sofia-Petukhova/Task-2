...
def print_menu() -> None:
    print("\n=== МЕНЮ ===")
    print("1 — повторяющиеся элементы массива А, которые есть в массиве В")
    print("2 — элементы, присутствующие в обоих массивах А и В")
    print("3 — элементы, которые присутствуют в нескольких экземплярах либо в массиве А, либо в массиве В (либо в обоих массивах)")
    print("0 — Выход")
    print("============")
